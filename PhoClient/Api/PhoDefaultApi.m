...
@interface PhoDefaultApi ()

@property (nonatomic, strong) NSMutableDictionary *defaultHeaders;

@end

@implementation PhoDefaultApi

NSString* kPhoDefaultApiErrorDomain = @"PhoDefaultApiErrorDomain";
NSInteger kPhoDefaultApiMissingParamErrorCode = 234513;
...
- (instancetype) init {
    self = [super init];
    if (self) {
        PhoConfiguration *config = [PhoConfiguration sharedConfig];
        if (config.apiClient == nil) {
            config.apiClient = [[PhoApiClient alloc] init];
        }
...
- (id) initWithApiClient:(PhoApiClient *)apiClient {
    self = [super init];
    if (self) {
...
+ (instancetype)sharedAPI {
    static PhoDefaultApi *sharedAPI;
...
-(NSUInteger) requestQueueSize {
    return [PhoApiClient requestQueueSize];
}
...
-(NSNumber*) addAttributeWithValue: (NSString*) value
    ...
    return [self.apiClient requestWithPath: resourcePath
                       ...
                       responseContentType: responseContentType
                              responseType: @"PhoInlineResponse2004*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((PhoInlineResponse2004*)data, error);
                                }
                           }
          ];
}
...
-(NSNumber*) delEntityWithCompletionHandler: 
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/{uuid}"];
...
-(NSNumber*) getAllEdgesWithUuid: (NSString*) uuid
    ...
    if (uuid == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kPhoDefaultApiErrorDomain code:kPhoDefaultApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }

    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/{uuid}/edges/all"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"PhoInlineResponse2003*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((PhoInlineResponse2003*)data, error);
                                }
                           }
          ];
}
...
-(NSNumber*) getAttributesWithUuid: (NSString*) uuid
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/{uuid}/attributes"];
...
-(NSNumber*) getEdgeWithUuid: (NSString*) uuid
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/edge/{uuid}"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"PhoEdge*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((PhoEdge*)data, error);
                                }
                           }
          ];
}
...
-(NSNumber*) getEdgeGettersWithUuid: (NSString*) uuid
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/{uuid}/edges/getters"];
...
-(NSNumber*) getEdgeSettersWithUuid: (NSString*) uuid
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/{uuid}/edges/setters"];
...
///  @returns PhoInlineResponse200*
///
-(NSNumber*) getFounderWithCompletionHandler: 
    (void (^)(PhoInlineResponse200* output, NSError* error)) handler {
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/founder"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"PhoInlineResponse200*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((PhoInlineResponse200*)data, error);
                                }
                           }
          ];
}
...
///  @returns PhoInlineResponse2001*
///
-(NSNumber*) getGraphWithCompletionHandler: 
    (void (^)(PhoInlineResponse2001* output, NSError* error)) handler {
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/graph"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"PhoInlineResponse2001*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((PhoInlineResponse2001*)data, error);
                                }
                           }
          ];
}
...
-(NSNumber*) getIncomingEdgesWithUuid: (NSString*) uuid
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/{uuid}/edges/in"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"NSArray<PhoNodeEdge>*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((NSArray<PhoNodeEdge>*)data, error);
                                }
                           }
          ];
}
...
-(NSNumber*) getNodeWithUuid: (NSString*) uuid
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"PhoNode*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((PhoNode*)data, error);
                                }
                           }
          ];
}
...
-(NSNumber*) getNodeEdgeWithUuid: (NSString*) uuid
    ...
    if (edge == nil) {
        NSParameterAssert(edge);
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"edge"] };
            NSError* error = [NSError errorWithDomain:kPhoDefaultApiErrorDomain code:kPhoDefaultApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/{uuid}/{edge}"];
...
-(NSNumber*) getOutgoingEdgesWithUuid: (NSString*) uuid
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/{uuid}/edges/out"];
...
///  @returns PhoInlineResponse2002*
///
-(NSNumber*) getSpaceWithCompletionHandler: 
    (void (^)(PhoInlineResponse2002* output, NSError* error)) handler {
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/space"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"PhoInlineResponse2002*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((PhoInlineResponse2002*)data, error);
                                }
                           }
          ];
}
...
-(NSNumber*) getTypeWithUuid: (NSString*) uuid
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/{uuid}/type"];
...
-(NSNumber*) makeActorWithParam1: (NSString*) param1
    completionHandler: (void (^)(NSString* output, NSError* error)) handler {
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/actor"];
