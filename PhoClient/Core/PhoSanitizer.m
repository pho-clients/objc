#import "PhoSanitizer.h"
#import "PhoObject.h"
#import "PhoQueryParamCollection.h"
#import <ISO8601/ISO8601.h>

NSString * PhoPercentEscapedStringFromString(NSString *string) {
    static NSString * const kPhoCharactersGeneralDelimitersToEncode = @":#[]@";
    static NSString * const kPhoCharactersSubDelimitersToEncode = @"!$&'()*+,;=";

    NSMutableCharacterSet * allowedCharacterSet = [[NSCharacterSet URLQueryAllowedCharacterSet] mutableCopy];
    [allowedCharacterSet removeCharactersInString:[kPhoCharactersGeneralDelimitersToEncode stringByAppendingString:kPhoCharactersSubDelimitersToEncode]];
...
- (id) sanitizeForSerialization:(id) object {
    ...
    else if ([object isKindOfClass:[NSString class]] || [object isKindOfClass:[NSNumber class]] || [object isKindOfClass:[PhoQueryParamCollection class]]) {
        return object;
    }
    ...
    else if ([object isKindOfClass:[PhoObject class]]) {
