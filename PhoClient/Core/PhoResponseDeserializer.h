 ...
 */
extern NSString *const PhoDeserializationErrorDomainKey;

/**
 * Code for deserialization type mismatch error
 */
extern NSInteger const PhoTypeMismatchErrorCode;

/**
 * Code for deserialization empty value error
 */
extern NSInteger const PhoEmptyValueOccurredErrorCode;

/**
 * Error code for unknown response
 */
extern NSInteger const PhoUnknownResponseObjectErrorCode;

@protocol PhoResponseDeserializer <NSObject>
...
@interface PhoResponseDeserializer : NSObject <PhoResponseDeserializer>
