 ...
 */
extern NSString *const PhoResponseObjectErrorKey;

@interface PhoApiClient : AFHTTPSessionManager

@property(nonatomic, assign) NSURLRequestCachePolicy cachePolicy;
@property(nonatomic, assign) NSTimeInterval timeoutInterval;
@property(nonatomic, readonly) NSOperationQueue* queue;

/// In order to ensure the HTTPResponseHeaders are correct, it is recommended to initialize one PhoApiClient instance per thread.
@property(nonatomic, readonly) NSDictionary* HTTPResponseHeaders;

@property(nonatomic, strong) id<PhoResponseDeserializer> responseDeserializer;

@property(nonatomic, strong) id<PhoSanitizer> sanitizer;
/**
 * Clears Cache
 */
+(void)clearCache;
...
/**
 * PhoConfiguration return sharedConfig
 *
 * @return PhoConfiguration
 */
