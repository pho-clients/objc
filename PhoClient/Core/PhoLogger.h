...
#ifndef PhoDebugLogResponse
#define PhoDebugLogResponse(response, responseObject,request, error) [[PhoLogger sharedLogger] logResponse:response responseObject:responseObject request:request error:error];
#endif
 ...
 */
#ifndef PhoDebugLog
#define PhoDebugLog(format, ...) [[PhoLogger sharedLogger] debugLog:[NSString stringWithFormat:@"%s", __PRETTY_FUNCTION__] message: format, ##__VA_ARGS__];
#endif

@interface PhoLogger : NSObject

+(instancetype)sharedLogger;

/**
 * Enabled switch, default NO - default set by PhoConfiguration debug property
 */
