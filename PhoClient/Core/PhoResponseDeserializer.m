#import "PhoResponseDeserializer.h"
#import <JSONModel/JSONModel.h>
#import <ISO8601/ISO8601.h>

NSString *const PhoDeserializationErrorDomainKey = @"PhoDeserializationErrorDomainKey";

NSInteger const PhoTypeMismatchErrorCode = 143553;

NSInteger const PhoEmptyValueOccurredErrorCode = 143509;

NSInteger const PhoUnknownResponseObjectErrorCode = 143528;


@interface PhoResponseDeserializer ()
...
@implementation PhoResponseDeserializer
...
-(NSError *)typeMismatchErrorWithExpectedType:(NSString *)expected data:(id)data {
    ...
    return [NSError errorWithDomain:PhoDeserializationErrorDomainKey code:PhoTypeMismatchErrorCode userInfo:userInfo];
}
...
-(NSError *)emptyValueOccurredError {
    ...
    NSDictionary * userInfo = @{NSLocalizedDescriptionKey : message};
    return [NSError errorWithDomain:PhoDeserializationErrorDomainKey code:PhoEmptyValueOccurredErrorCode userInfo:userInfo];
}
...
-(NSError *)unknownResponseErrorWithExpectedType:(NSString *)expected data:(id)data  {
    ...
    NSDictionary * userInfo = @{NSLocalizedDescriptionKey : message};
    return [NSError errorWithDomain:PhoDeserializationErrorDomainKey code:PhoUnknownResponseObjectErrorCode userInfo:userInfo];
}
