#import "PhoConfiguration.h"

@interface PhoConfiguration ()
...
@implementation PhoConfiguration

#pragma mark - Singleton Methods

+ (instancetype) sharedConfig {
    static PhoConfiguration *shardConfig = nil;
...
- (instancetype) init {
    ...
    if (self) {
        self.apiClient = nil;
        self.host = @"https://virtserver.swaggerhub.com/phonetworks/server-rest/1.1.0";
        self.username = @"";
        self.password = @"";
        self.accessToken= @"";
        self.verifySSL = YES;
        ...
        self.mutableDefaultHeaders[@"User-Agent"] = [NSString stringWithFormat:@"Swagger-Codegen/1.1.1/objc (%@; iOS %@; Scale/%0.2f)",[[UIDevice currentDevice] model], [[UIDevice currentDevice] systemVersion], [[UIScreen mainScreen] scale]];
        self.logger = [PhoLogger sharedLogger];
    }
    return self;
}
